 ...
 */
function Clue({ direction, number, children, complete, correct, ...props }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(ClueWrapper, { highlightBackground: highlightBackground, highlight: focused && direction === selectedDirection && number === selectedNumber, complete: complete, correct: correct, ...props, onClick: handleClick, "aria-label": `clue-${number}-${direction}`, children: [number, ": ", children] }));
}
