...
function Cell({ cellData, onClick, focus, highlight, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { onClick: handleClick, style: { cursor: 'default', fontSize: `${fontSize}px` }, className: "clue-cell", children: [(0, jsx_runtime_1.jsx)("rect", { x: x + cellPadding, y: y + cellPadding, width: cellInner, height: cellInner, fill: focus
                    ? focusBackground
                    : highlight
                        ? highlightBackground
                        : cellBackground, stroke: cellBorder, strokeWidth: cellSize / 50 }), number && ((0, jsx_runtime_1.jsx)("text", { x: x + cellPadding * 4, y: y + cellPadding * 4, textAnchor: "start", dominantBaseline: "hanging", style: { fontSize: '50%', fill: numberColor }, children: number })), (0, jsx_runtime_1.jsx)("text", { x: x + cellHalf, y: y + cellHalf + 1, textAnchor: "middle", dominantBaseline: "middle", style: { fill: textColor }, className: answer === guess ? 'guess-text-correct' : 'guess-text-incorrect', children: guess })] }));
}
