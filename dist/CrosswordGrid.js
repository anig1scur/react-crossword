...
function CrosswordGrid({ theme }) {
    ...
    return ((0, jsx_runtime_1.jsx)(context_1.CrosswordSizeContext.Provider, { value: sizeContext, children: (0, jsx_runtime_1.jsx)(styled_components_1.ThemeProvider, { theme: finalTheme, children: (0, jsx_runtime_1.jsx)(GridWrapper, { children: (0, jsx_runtime_1.jsxs)("div", { style: { margin: 0, padding: 0, position: 'relative' }, children: [(0, jsx_runtime_1.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, children: [(0, jsx_runtime_1.jsx)("rect", { x: 0, y: 0, width: width, height: height, fill: finalTheme.gridBackground }), gridData.flatMap((rowData, row) => rowData.map((cellData, col) => cellData.used ? (
