...
function DirectionClues({ direction, label, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "direction", children: [(0, jsx_runtime_1.jsx)("h3", { className: "header", children: label || direction.toUpperCase() }), clues === null || clues === void 0 ? void 0 : clues[direction].map(({ number, clue, complete, correct }) => ((0, jsx_runtime_1.jsx)(Clue_1.default, { direction: direction, number: number, complete: complete, correct: correct, children: clue }, number)))] }));
}
