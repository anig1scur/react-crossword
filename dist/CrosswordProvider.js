...
exports.crosswordProviderPropTypes = {
     ...
     */
    onCellSelected: prop_types_1.default.func,
    /**
 ...
 * @since 4.0
 */
const CrosswordProvider = react_1.default.forwardRef(({ data, theme, onAnswerComplete, onAnswerCorrect, onCorrect, onAnswerIncorrect, onLoadedCorrect, onCrosswordComplete, onCrosswordCorrect, onCellChange, onCellSelected, onClueSelected, useStorage, storageKey, children, }, ref) => {
    ...
    const finalTheme = (0, react_1.useMemo)(() => ({ ...defaultTheme, ...contextTheme, ...theme }), [contextTheme, theme]);
    ...
    const moveTo = (0, react_1.useCallback)((row, col, directionOverride) => {
        ...
        if (onCellSelected) {
            onCellSelected(direction, (_b = candidate[direction]) !== null && _b !== void 0 ? _b : '', row, col);
        }
        return candidate;
    ...
    const handleInputKeyDown = (0, react_1.useCallback)((event) => {
        ...
        switch (key) {
            ...
            case 'Tab': {
                ...
                if (onCellSelected) {
                    onCellSelected(other, (_b = cellData[other]) !== null && _b !== void 0 ? _b : '', focusedRow, focusedCol);
                }
                break;
            }
    ...
    const handleCellClick = (0, react_1.useCallback)((cellData) => {
        ...
        if (cellData.used) {
            ...
            if (onCellSelected) {
                onCellSelected(direction, (_b = cellData[direction]) !== null && _b !== void 0 ? _b : '', row, col);
            }
        }
        focus();
    ...
    const handleInputClick = (0, react_1.useCallback)(( /* event */) => {
        ...
        focus();
        if (onCellSelected) {
            onCellSelected(direction, (_b = cellData[direction]) !== null && _b !== void 0 ? _b : '', focusedCol, focusedRow);
        }
    }, [
        currentDirection,
        focus,
    ...
    return ((0, jsx_runtime_1.jsx)(styled_components_1.ThemeProvider, { theme: finalTheme, children: (0, jsx_runtime_1.jsx)(context_1.CrosswordContext.Provider, { value: crosswordContext, children: children }) }));
});
