...
const crosswordPropTypes = {
    ...CrosswordProvider_1.crosswordProviderPropTypes,
 ...
 * functionality.
 */
const Crossword = react_1.default.forwardRef(({ acrossLabel, downLabel, ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(CrosswordProvider_1.default, { ...props, ref: providerRef, children: [(0, jsx_runtime_1.jsx)(CrosswordGrid_1.default, {}), (0, jsx_runtime_1.jsxs)(CluesWrapper, { children: [(0, jsx_runtime_1.jsx)(DirectionClues_1.default, { direction: "across", label: acrossLabel }), (0, jsx_runtime_1.jsx)(DirectionClues_1.default, { direction: "down", label: downLabel })] })] }));
});
Crossword.displayName = 'Crossword';
Crossword.propTypes = crosswordPropTypes;
Crossword.defaultProps = {
    ...CrosswordProvider_1.default.defaultProps,
